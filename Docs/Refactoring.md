...
The session-by-session record of rounds R2 and R3 — batch reports, engine-bump follow-ups and bug hunts —
lives in [History/Refactoring-2026.md](History/Refactoring-2026.md). Standing decisions stay here.
